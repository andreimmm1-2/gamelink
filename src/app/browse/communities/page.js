  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <h1 className="text-5xl font-black text-white mb-2">👥 Browse Communities</h1>
        <p className="text-slate-400 mb-8">Join gaming communities and connect with players</p>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-slate-800 rounded-lg border border-slate-700">
            ...
            <p className="text-slate-400">Be the first to create a community!</p>
          </div>
        ) : (
            ...
            {communities.map(community => (
              <Link key={community.id} href={`/communities/${community.id}`}>
                <div className="bg-slate-800 border border-slate-700 rounded-lg p-6 hover:border-indigo-500 transition h-full">
                  ...
                  <p className="text-sm text-slate-400 mb-3">{community.members} members</p>
