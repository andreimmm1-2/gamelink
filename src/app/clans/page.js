  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <h1 className="text-5xl font-black text-white mb-2">⚔️ Clans & Guilds</h1>
        <p className="text-slate-400 mb-8">Join or create a clan to squad up with players</p>
        ...
        {clans.length === 0 ? (
          <div className="text-center py-12 bg-slate-800 rounded-lg border border-slate-700">
            ...
            <p className="text-slate-400">Be the first to create a clan for {selectedGame || 'your game'}!</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">Clan listings</div>
        )}
      </div>
    </main>
  )
